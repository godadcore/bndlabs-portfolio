      ...
      <div className="homeFooterInner">
        ...
        <p className="footerCopy">
          ...
          <span className="footerContactRow">
            <a className="footerEmail" href={`mailto:${contactEmail}`}>
              {contactEmail}
            </a>
          </span>
        </p>
        ...
        <div className="footerLinks" aria-label="Footer links">
          <a href={socialLinks.x} aria-label="X" target="_blank" rel="noreferrer noopener">
          ...
          <a href={socialLinks.behance} aria-label="Behance" target="_blank" rel="noreferrer noopener">
            <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href={socialLinks.instagram} aria-label="Instagram" target="_blank" rel="noreferrer noopener">
            <svg viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href={socialLinks.tiktok} aria-label="TikTok" target="_blank" rel="noreferrer noopener">
            <svg viewBox="0 0 24 24" aria-hidden="true">
